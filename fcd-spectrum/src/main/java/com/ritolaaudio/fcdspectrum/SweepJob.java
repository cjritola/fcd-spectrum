...
public class SweepJob
	...
	public SweepJob(double startFrequency, double endFrequency, Integer gainValue, File targetFile, int fftSize, Logger log) throws IllegalArgumentException
		{
