...
public class AudioCaptureUnavailableException extends AudioCaptureAcquisitionException
	{
	public AudioCaptureUnavailableException(){super();}
	public AudioCaptureUnavailableException(String message){super(message);}
	}
