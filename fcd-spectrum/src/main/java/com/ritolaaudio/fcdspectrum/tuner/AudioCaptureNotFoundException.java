...
public class AudioCaptureNotFoundException extends AudioCaptureAcquisitionException
	{
	public AudioCaptureNotFoundException(){super();}
	public AudioCaptureNotFoundException(String message){super(message);}
	}
