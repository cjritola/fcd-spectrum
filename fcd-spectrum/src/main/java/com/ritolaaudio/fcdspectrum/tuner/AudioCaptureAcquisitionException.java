...
public class AudioCaptureAcquisitionException extends TunerException
	{
	public AudioCaptureAcquisitionException(){super();}
	public AudioCaptureAcquisitionException(Exception cause){super(cause);}
	public AudioCaptureAcquisitionException(String message){super(message);}
	}
