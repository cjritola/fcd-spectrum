...
public class FuncubeNotFoundException extends TunerNotFoundException
	{
	public FuncubeNotFoundException(){super();}
	public FuncubeNotFoundException(String msg){super(msg);}
	}
